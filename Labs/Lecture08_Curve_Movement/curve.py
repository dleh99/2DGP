...
p3 = x3, y3 = random.randint(-300, -100), random.randint(-300, -100)
p4 = x4, y4 = random.randint(100, 300), random.randint(-300, -100)
...
# draw_curve_3_points(p5, p6, p7)
# draw_curve_4_points(p2, p3, p1, p4)
draw_curve_5_points(p2, p3, p1, p4, p5)
